...
- Agents must not add themselves as a co-author or collaborator when commenting, committing, or opening pull requests.
- Do not append `Co-Authored-By` trailers, agent signatures, or "generated by" attribution lines to commits, PRs, issues, or code comments.
